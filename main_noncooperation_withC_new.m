...
L=0.2;%price per unit of server capacity C
B=2;%benefit brought to ISP per unit of server capacity C
C=0;%server capacity
...
for i=1:length(p)
    BR_ISP(i)=optimal_p_ISP_noncooperation( BR_CDN(1,i),q0,pmax,p0,D,N,BR_CDN(2,i),delta,k,l,B,1 );
end
...
saveresult([U_ISP U_CDN U q_opt p_opt C_opt n_opt d_opt Q_opt],'D:\Users\liao\ÎÄµµ\MATLAB\CDN\result\','noncooperationwithC_k=3_new','.txt');