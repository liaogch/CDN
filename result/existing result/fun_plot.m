...
hold on;
D1_cooperation=textread('cooperation_k=1.75_.txt')
D2_cooperation=textread('cooperation_k=2_.txt')
D3_cooperation=textread('cooperation_k=2.25_.txt')
D4_cooperation=textread('cooperation_k=2.5_.txt')
D5_cooperation=textread('cooperation_k=2.75_.txt')
D6_cooperation=textread('cooperation_k=3_.txt')
p_cooperation = [D1_cooperation(3) D2_cooperation(3) D3_cooperation(3) D4_cooperation(3) D5_cooperation(3) D6_cooperation(3)]

D1_cooperation_new=textread('cooperation_k=1.75_new.txt')
D2_cooperation_new=textread('cooperation_k=2_new.txt')
D3_cooperation_new=textread('cooperation_k=2.25_new.txt')
D4_cooperation_new=textread('cooperation_k=2.5_new.txt')
D5_cooperation_new=textread('cooperation_k=2.75_new.txt')
D6_cooperation_new=textread('cooperation_k=3_new.txt')
p_cooperation_new = [D1_cooperation_new(3) D2_cooperation_new(3) D3_cooperation_new(3) D4_cooperation_new(3) D5_cooperation_new(3) D6_cooperation_new(3)]
...
D1_noncooperationwithC=textread('noncooperationwithC_k=1.75_.txt')
D2_noncooperationwithC=textread('noncooperationwithC_k=2_.txt')
D3_noncooperationwithC=textread('noncooperationwithC_k=2.25_.txt')
D4_noncooperationwithC=textread('noncooperationwithC_k=2.5_.txt')
D5_noncooperationwithC=textread('noncooperationwithC_k=2.75_.txt')
D6_noncooperationwithC=textread('noncooperationwithC_k=3_.txt')
...
D1_noncooperationwithC_new=textread('noncooperationwithC_k=1.75_new.txt')
D2_noncooperationwithC_new=textread('noncooperationwithC_k=2_new.txt')
D3_noncooperationwithC_new=textread('noncooperationwithC_k=2.25_new.txt')
D4_noncooperationwithC_new=textread('noncooperationwithC_k=2.5_new.txt')
D5_noncooperationwithC_new=textread('noncooperationwithC_k=2.75_new.txt')
D6_noncooperationwithC_new=textread('noncooperationwithC_k=3_new.txt')
p_noncooperationwithC_new=[D1_noncooperationwithC_new(5) D2_noncooperationwithC_new(5) D3_noncooperationwithC_new(5) D4_noncooperationwithC_new(5) D5_noncooperationwithC_new(5) D6_noncooperationwithC_new(5)]
