...
for q=1:0.1:2
    ...
    for p=3:0.1:6
            for C=8:0.1:10
                ...
                Res = n*q+d*p-L*C+B*min(n,C);
                %Res = n*q+d*p+(B-L)*min(n,C);
                if Res>U
                    U = Res;
                    q_opt = q;
                    p_opt = p;
...
d_opt
Q_opt
saveresult([U q_opt p_opt C_opt n_opt d_opt Q_opt],'D:\Users\liao\ÎÄµµ\MATLAB\CDN\result\','cooperation_k=3_new','.txt');